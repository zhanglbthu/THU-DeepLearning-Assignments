...
class DeepGCN(torch.nn.Module):
    def __init__(self, num_layer=6, hidden_dim=64):
        ...
        # 第一层
        self.convs.append(GCNConv(dataset.num_features + 3, hidden_dim))
...
model = DeepGCN(hidden_dim=128).to(device)
optimizer = optim.Adam(model.parameters(), lr=0.001)
log_dir = './checkpoints/deep_gcn'
